...
import com.td.tvsuit.leanback.TvLayoutManager;
import com.td.tvsuit.leanback.utils.Loger;
...
public class TvRecyclerView extends RecyclerView implements View.OnClickListener, View.OnFocusChangeListener {
    private static final int DEFAULT_LOAD_MORE_BEFOREHAND_COUNT = 0;
...
//                            onFocusChanged(false, FOCUS_DOWN, null);
    ...
    public void onScrollStateChanged(int state) {
        if (state == SCROLL_STATE_IDLE) {
            ...
            int minLimit = totalItemCount - rowCount;
            int maxLimit = totalItemCount;
            if (getLastVisiblePosition() < maxLimit && getLastVisiblePosition() > minLimit) {
    ...
    public boolean requestChildRectangleOnScreen(View child, Rect rect, boolean immediate) {
        ...
        if (mSelectedItemCentered) {
            ...
            mSelectedItemOffsetStart = (getLayoutManager().canScrollHorizontally() ? (getFreeWidth() - mTempRect.width()) : (getFreeHeight() - mTempRect.height())) / 2;
    ...
    public boolean canScrollHorizontally(int direction) {
        if (null != getLayoutManager() && getLayoutManager() instanceof TvLayoutManager) {
            final TvLayoutManager lm = (TvLayoutManager) getLayoutManager();
    ...
    public VLayoutManager getTVLayoutManager() {
        if (getLayoutManager() instanceof VLayoutManager) {
            return (VLayoutManager) getLayoutManager();
        }
        return (VLayoutManager) getLayoutManager();
    }
...
//    }
    ...
    protected static class ISavedState extends BaseSavedState {
