...
public class TvTabLayout extends HorizontalScrollView {
    ...
    private com.td.tvsuit.leanback.widget.tablayout.ValueAnimatorCompat mScrollAnimator;
    ...
    public TvTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mIndicatorGravity = a.getInt(R.styleable.TvTabLayout_tabLayoutIndicatorGravity, GRAVITY_BOTTOM);
        ...
        mTabGravity = a.getInt(R.styleable.TvTabLayout_tabLayoutGravity, GRAVITY_CENTER);
    ...
    /**
     * Sets the text color for the different states (normal, selected) used for the tabs.
     *
    ...
    /**
     * Gets the text color for the different states (normal, selected) used for the tabs.
     */
    @Nullable
    ...
    public class TabView extends LinearLayout implements OnLongClickListener {
        ...
        public TabView(Context context) {
            ...
            layoutParams.leftMargin = Utils.dp2px(getContext(), 30);
            layoutParams.rightMargin = Utils.dp2px(getContext(), 30);
